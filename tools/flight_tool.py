...
# This dictionary handles common country names and alternative spellings
COUNTRY_ALIASES = {
    "usa": "US",
    "u.s.a": "US",
    "u.s.": "US",
...
# cleans a natural-language phrase before location matching
def clean_text(text:str) -> str:
    ...
    # These words are removed because they do not identify a location.
    stop_words = [
...
# converts country text into a two-letter ISO country code
def country_name_to_code(text:str):
    # 1: clean the text
    text = clean_text(text)

    # 2: check custom aliases
...
# finds suitable airport for a country
